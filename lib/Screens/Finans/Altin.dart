...
class _AltinState extends State<Altin> with AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<AltinProvider>(context, listen: false)
          .getData('daily', 'SCUM');
      Provider.of<AltinProvider>(context, listen: false).getcodeinfo('SCUM');
    });
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Stack(
              children: [
                  ...
                  child: Consumer<AltinProvider>(
                    builder: (context, data, child) {
                      if (data.dat.isNotEmpty && data.dat.isNotEmpty != null) {
                        return Selector<AltinProvider, dynamic>(
                ...
                Positioned(
                  top: 10,
                  left: 10,
                  child: Selector<AltinProvider, bool>(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              onTap: () {
                                String symbol = Provider.of<AltinProvider>(
                                        context,
                                        listen: false)
                                    .selectedhisse
                                    .symbol;
                                Provider.of<AltinProvider>(context,
                                        listen: false)
            ...
            Selector<AltinProvider, Snapshots>(
